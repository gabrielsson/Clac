...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[] {
            "#38:password", "#68:is", "#62:not", "#71:essential",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        preferences = getSharedPreferences(APP_SHARED_PREFS, Context.MODE_PRIVATE);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(username)) {
            ...
            cancel = true;
        } else if (!isNumberValid(username)) {
            mUsernameView.setError("This number is invalid");
            focusView = mUsernameView;
            cancel = true;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Log.d("XXX_SWO", "Setting extra to " + mUsername + ":" + mPassword);
                preferences.edit()
